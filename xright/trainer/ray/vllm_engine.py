...
from xright.utils.logging import init_logger
...
class LLMRayActor:
    def __init__(self, *args, **kwargs):
        ...
        if self.use_gpu_executor:
            from xright.trainer.ray.vllm_worker_wrap import WorkerWrap
            ...
            class RayWorkerWrapper(RayWorkerWrapperPath.RayWorkerWrapper):
                def __init__(self, *args, **kwargs) -> None:
                    kwargs["worker_module_name"] = "xright.trainer.ray.vllm_worker_wrap"
